...
{
	LCD_Show_Image(0, 0, 240, 240, Hoslcrek);
}
#endif
...
{
	LCD_Show_Image(0, 0, 240, 240, TongFei);
}
#endif
...
static void LCD_Gpio_Init(void)
{
    ...
    /*
    	...
    	LCD_CS:		PB1
    */
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_13 | GPIO_Pin_14| GPIO_Pin_15 | GPIO_Pin_1;
	...
	GPIO_ResetBits(GPIOB,GPIO_Pin_13 | GPIO_Pin_14| GPIO_Pin_15 |GPIO_Pin_1);
